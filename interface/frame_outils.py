...
class FrameOutils(Frame):
    def __init__(self,boss):
        ...
        self.combobox_white["values"] = ('joueur', 'aleatoire','minmax','minmax2')
        ...
        self.combobox_black["values"] = ('joueur', 'aleatoire','minmax','minmax2','stockfish')
        self.combobox_black.current(4)
