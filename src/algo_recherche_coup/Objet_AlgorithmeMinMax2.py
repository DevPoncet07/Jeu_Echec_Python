...
class AlgorithmeMinMax2:
    ...
    def trouve_un_coup(self,objet_plateau,profondeur=2):
        ...
        while self.liste_node_new:
            ...
            if len(self.liste_node_vue)%100==0:
                print(len(self.liste_node_vue))
            self.liste_node_vue.append(node_temp)
        print("node vue : ",len(self.liste_node_vue),"    node new :",len(self.liste_node_new))
        index=self.meilleur_index_boss(self.node_boss)
        print(index,len(self.objet_plateau.coups_possible))
        print("**** fin cherche un coup minmax ****")
    ...
    def meilleur_index_boss(self,node):
        ...
        print(liste_score,meilleur_index)
